...
import {tippmixAllProducts} from '../helpers/tippmixProducts';
import DeleteIcon from '../assets/delete_icon.png';

const TippMixCartItemComponent = ({item}) => {
  ...
  const productImage = tippmixAllProducts.find(
    p => p.name === item.name,
  )?.image;
...
export default TippMixCartItemComponent;
